...
Based on parameter estimates and goodness of fit tests, I select with both average number of cigarettes smoked per day during pregnancy and mother’s age at menarche (years). There is not significant interaction between these terms.

My model is: `lm(bwt ~ smoken + menarche)`.
